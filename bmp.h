...
void rgbaToBw_v4(uint32_t *pixel, int width, int height, long stride);

void rgbaToBw_v5(uint32_t *pixel, int width, int height, long stride);
void rgbaToBw_v6(uint8_t *pixel, int width, int height, long stride);
